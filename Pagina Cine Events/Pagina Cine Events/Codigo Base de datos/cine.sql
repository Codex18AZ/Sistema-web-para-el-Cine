...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-08-2021 a las 23:12:08
...
(0, 2, NULL, 5, 'Marlon Brando es un capo, su mejor interpretación hasta la fecha. En sí, toda la película es una obra de arte espectacular.', 3),
...
(15, 5, '2021-07-10 05:06:16', 5, 'Muy buena película, me encanto Xd', 2),
...
(21, 1, NULL, 4, 'Me encanto esta pelicula', 23),
(22, 1, NULL, 5, 'Esta película realmente me gusto debido a su profundidad artista.', 24);
...
CREATE TABLE `pelicula` (
  ...
  `Titulo` varchar(75) COLLATE utf8_unicode_ci DEFAULT NULL,
  `tituloOriginal` varchar(50) COLLATE utf8_unicode_ci DEFAULT NULL,
...
(1, 'Sueños de fuga', 'The Shawshank Redemption', 'Drama', 'Inglés', 0, 'Estados Unidos', 1993, 'https://www.warnerbros.com/movies/shawshank-redemption', '2h 22min', '+15', '1994-10-14', 'Acusado del asesinato de su mujer, Andrew Dufresne (Tim Robbins), tras ser condenado a cadena perpetua, es enviado a la cárcel de Shawshank. Con el paso de los años conseguirá ganarse la confianza del director del centro y el respeto de sus compañeros de prisión, especialmente de Red (Morgan Freeman), el jefe de la mafia de los sobornos.'),
(2, 'El padrino', 'The Godfather', 'Drama', 'Inglés', 1, 'Estados Unidos', 1971, 'https://www.paramount.com/movies/godfather-collection', '2h 55min', '+18', '1972-03-15', 'América, años 40. Don Vito Corleone (Marlon Brando) es el respetado y temido jefe de una de las cinco familias de la mafia de Nueva York. Tiene cuatro hijos: Connie (Talia Shire), el impulsivo Sonny (James Caan), el pusilánime Fredo (John Cazale) y Michael (Al Pacino), que no quiere saber nada de los negocios de su padre. Cuando Corleone, en contra de los consejos de \'Il consigliere\' Tom Hagen (Robert Duvall), se niega a participar en el negocio de las drogas, el jefe de otra banda ordena su asesinato. Empieza entonces una violenta y cruenta guerra entre las familias mafiosas.'),
(3, 'El padrino II', 'The Godfather Part II', 'Drama', 'Inglés', 1, 'Estados Unidos', 1973, 'https://www.paramount.com/movies/godfather-collection', '3h 22min', '+18', '1974-12-20', 'Continuación de la historia de los Corleone por medio de dos historias paralelas: la elección de Michael como jefe de los negocios familiares y los orígenes del patriarca, Don Vito Corleone, primero en su Sicilia natal y posteriormente en Estados Unidos, donde, empezando desde abajo, llegó a ser un poderosísimo jefe de la mafia de Nueva York.'),
(4, 'Batman - El caballero de la noche', 'The Dark Knight', 'Acción', 'Inglés', 0, 'Estados Unidos', 2007, 'https://www.warnerbros.com/movies/dark-knight', '2h 32min', '+15', '2008-07-17', 'Batman/Bruce Wayne (Christian Bale) regresa para continuar su guerra contra el crimen. Con la ayuda del teniente Jim Gordon (Gary Oldman) y del Fiscal del Distrito Harvey Dent (Aaron Eckhart), Batman se propone destruir el crimen organizado en la ciudad de Gotham. El triunvirato demuestra su eficacia, pero, de repente, aparece Joker (Heath Ledger), un nuevo criminal que desencadena el caos y tiene aterrados a los ciudadanos.'),
(5, '12 hombres en pugna', '12 Angry Men', 'Drama', 'Inglés', 0, 'Estados Unidos', 1956, 'https://www.criterion.com/films/27871-12-angry-men', '1h 36min', '+15', '1957-04-10', 'Los doce miembros de un jurado deben juzgar a un adolescente acusado de haber matado a su padre. Todos menos uno están convencidos de la culpabilidad del acusado. El que disiente intenta con sus razonamientos introducir en el debate una duda razonable que haga recapacitar a sus compañeros para que cambien el sentido de su voto.'),
(6, 'La lista de Schindler', 'Schindler\'s List', 'Drama', 'Inglés', 1, 'Estados Unidos', 1992, 'https://www.universalpictures.com/movies/schindlers-list', '3h 15min', '+15', '1994-02-24', 'Oskar Schindler (Liam Neeson), un empresario alemán de gran talento para las relaciones públicas, busca ganarse la simpatía de los nazis de cara a su beneficio personal. Después de la invasión de Polonia por los alemanes en 1939, Schindler consigue, gracias a sus relaciones con los altos jerarcas nazis, la propiedad de una fábrica de Cracovia. Allí emplea a cientos de operarios judíos, cuya explotación le hace prosperar rápidamente, gracias sobre todo a su gerente Itzhak Stern (Ben Kingsley), también judío. Pero conforme la guerra avanza, Schindler y Stern comienzan ser conscientes de que a los judíos que contratan, los salvan de una muerte casi segura en el temible campo de concentración de Plaszow, que lidera el Comandante nazi Amon Goeth (Ralph Fiennes), un hombre cruel que disfruta ejecutando judíos.'),
...
(8, 'Tiempos violentos', 'Pulp Fiction', 'Drama', 'Inglés', 0, 'Estados Unidos', 1993, 'https://www.miramax.com/movie/pulp-fiction/', '2h 34min', '+18', '1995-02-24', 'Jules y Vincent, dos asesinos a sueldo con no demasiadas luces, trabajan para el gángster Marsellus Wallace. Vincent le confiesa a Jules que Marsellus le ha pedido que cuide de Mia, su atractiva mujer. Jules le recomienda prudencia porque es muy peligroso sobrepasarse con la novia del jefe. Cuando llega la hora de trabajar, ambos deben ponerse \"manos a la obra\". Su misión: recuperar un misterioso maletín.'),
(9, 'Lo bueno, lo malo y lo feo', 'Il buono, il brutto, il cattivo', 'Western', 'Inglés', 1, 'Italia', 1965, 'https://www.amazon.com/-/es/dp/B0013XZ6KW', '2h 41min', '+15', '1966-12-23', 'Durante la guerra civil norteamericana (1861-1865), tres cazadores de recompensas buscan un tesoro que ninguno de ellos puede encontrar sin la ayuda de los otros dos. Así que colaboran entre sí para conseguir el botín.'),
(10, 'El señor de los anillos: La comunidad del anillo', 'The Lord of the Rings: The Fellowship of the Ring', 'Aventura', 'Inglés', 1, 'Nueva Zelanda', 2001, 'https://www.warnerbros.com/movies/lord-rings-fellowship-ring', '2h 58min', '+15', '2002-01-01', 'En la Tierra Media, el Señor Oscuro Sauron ordenó a los Elfos que forjaran los Grandes Anillos de Poder. Tres para los reyes Elfos, siete para los Señores Enanos, y nueve para los Hombres Mortales. Pero Saurón también forjó, en secreto, el Anillo Único, que tiene el poder de esclavizar toda la Tierra Media. Con la ayuda de sus amigos y de valientes aliados, el joven hobbit Frodo emprende un peligroso viaje con la misión de destruir el Anillo Único. Pero el malvado Sauron ordena la persecución del grupo, compuesto por Frodo y sus leales amigos hobbits, un mago, un hombre, un elfo y un enano. La misión es casi suicida pero necesaria, pues si Sauron con su ejército de orcos lograra recuperar el Anillo, sería el final de la Tierra Media.');
...
(1, '2021-01-01 08:00:00', '2021-12-31 22:00:00', 'Descuento del 20% para universitarios', '0.20', 7, 2),
(2, '2021-01-01 08:00:00', '2021-12-31 22:00:00', 'Descuento del 20% para universitarios', '0.20', 10, 2),
(3, '2021-01-01 08:00:00', '2021-12-31 22:00:00', 'Descuento del 20% para universitarios', '0.20', 4, 2),
(4, '2021-08-29 08:00:00', '2021-10-02 22:00:00', 'Descuento de primavera del 15%', '0.15', 2, 3),
(5, '2021-10-03 08:00:00', '2021-10-30 22:00:00', 'Descuento de primavera del 15%', '0.15', 6, 4),
(6, '2021-10-31 08:00:00', '2021-12-04 22:00:00', 'Descuento de primavera del 15%', '0.15', 8, 4),
(7, '2021-12-23 08:00:00', '2021-12-31 22:00:00', 'Descuento de Navidad del 20%', '0.20', 6, 5);
...
(0, 'jose', 'j', NULL, 'jose@gmail.com', 'jose', NULL),
...
(21, 'juan', 'events.com', NULL, 'juan@cinevents.com', '753', NULL),
(22, 'mmm', 'lllll', NULL, 'l@gmail.com', '123456789', NULL),
(23, 'Michael', 'M', NULL, 'Michael123@cinevents.com', '123', NULL),
(24, 'juan', 'J', NULL, 'juan123@cinevents.com', '123456', NULL);
